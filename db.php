...
if (!defined('SITE_ROOT')) {
    ...
    // If we are in a subfolder like admin/ or includes/, we need the parent
    $rootPath = $scriptDir;
    if (basename($rootPath) === 'admin') $rootPath = dirname($rootPath);
    if (basename($rootPath) === 'includes') $rootPath = dirname($rootPath);
    if (basename($rootPath) === 'superadmin') $rootPath = dirname($rootPath);
