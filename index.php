...
<section class="container mb-12" style="padding-bottom: 80px;">
    <div class="tutor-grid">
        <div class="tutor-image-wrap card" style="padding: 0; border: none;">
        ...
        <div>
            ...
            <div class="grid grid-cols-3">
                <div>
                    <div style="font-size: 1.5rem; font-weight: 700; color: var(--blue-600);">15+</div>
                    <div class="text-tertiary uppercase" style="font-size: 0.7rem; font-weight: 700;">Years Exp.</div>
                </div>
                <div>
                    <div style="font-size: 1.5rem; font-weight: 700; color: var(--blue-600);">10k+</div>
                    <div class="text-tertiary uppercase" style="font-size: 0.7rem; font-weight: 700;">Students</div>
                </div>
                <div>
                    <div style="font-size: 1.5rem; font-weight: 700; color: var(--blue-600);">50+</div>
                    <div class="text-tertiary uppercase" style="font-size: 0.7rem; font-weight: 700;">Courses</div>
                </div>
            </div>
        </div>
    </div>
...
<section class="container mb-12">
    <div class="card text-center" style="background: var(--blue-600); border: none; padding: 80px 40px; color: #fff;">
        <h2 style="color: #fff; margin-bottom: 1rem;">Ready to Start Your Journey?</h2>
        <p style="color: rgba(255,255,255,0.8); max-width: 500px; margin: 0 auto 2.5rem; font-size: 1.1rem;">Join thousands of students who are already learning and growing with us.</p>
        <div class="flex-center gap-3">
            <a href="register.php" class="btn btn-secondary btn-lg" style="background: #fff; border: none; color: var(--blue-600);">Get Started Now</a>
            <a href="courses.php" class="btn btn-ghost btn-lg" style="color: #fff; border: 1px solid rgba(255,255,255,0.3);">Browse Courses</a>
        </div>
    </div>
</section>
