        ...
        <div class="sidebar-footer">
            <?php if(isset($_SESSION['user_id'])): ?>
                <div class="sidebar-user">
                    ...
                    <a href="<?= SITE_ROOT ?>logout.php" class="sidebar-logout" title="Logout">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path></svg>
                    </a>
                </div>
            <?php else: ?>
                <div class="sidebar-login-actions">
                    <a href="<?= SITE_ROOT ?>login.php" class="sidebar-login-btn outline">Login</a>
                    <a href="<?= SITE_ROOT ?>register.php" class="sidebar-login-btn filled">Join Now</a>
                </div>
            <?php endif; ?>
        </div>
    </aside>
    ...
    <main class="main-wrapper">
        ...
        <header class="app-topbar">
            ...
            <div class="topbar-right">
                <?php if(isset($_SESSION['user_id'])): ?>
                <a href="<?= SITE_ROOT ?>notifications.php" class="topbar-notif">
